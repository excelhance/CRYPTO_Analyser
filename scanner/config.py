...
class CoingeckoCfg(_Base):
    ...
    base_url: str = Field(min_length=1, description="URL de base de l'API CoinGecko (tier Demo).")
    requests_per_minute: int = Field(
        gt=0, le=30, description="Limite d'appels/minute du tier Demo CoinGecko (30 max)."
    )


class DefillamaCfg(_Base):
    enabled: bool = True
    base_url: str = Field(min_length=1, description="URL de base de l'API DefiLlama.")
